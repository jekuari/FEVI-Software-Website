...
export default class SecondSection extends Component {
  ...
  appearElement() {
    ...
    const arrayFromStyleLeft = this.state.styleLeft; //ESTE ARRAY HAY QUE MODIFICARLO
      ...
      <div id="SecondSectionContainer">
          ...
          <div id="SecondSection">
               ...
               <div id="SecondSectionMethodology">
                 <div className='MethodologyText' style={this.state.styleLeft[0]}>
                 ...
                 <div className='flex center parent'><img src={firstStage} alt="Wireframe" className='MethodologyImage'/></div>
                 <div className='flex center' style={this.state.styleLeft[1]}><img src={wireframe} alt="Wireframe" className='MethodologyImage'/></div>
                 ...
                 <div className='MethodologyText' style={this.state.styleLeft[2]}>
                 ...
                 <div className='flex center parent' style={this.state.styleLeft[3]}><div className='flex center parent'><img src={fourthStage} alt="Wireframe" className='MethodologyImage'/><img src={beneficiosButton} alt="" className="animatedBeneficiosButton"/><img src={OrangeWheel} alt="" className='OrangeWheel' /></div></div>
                 <div className='flex center'><p className='MethodologyNumber'><strong>4</strong></p></div>
                 <div className='MethodologyText'>
                 ...
                 <div className='MethodologyText' style={this.state.styleLeft[4]}>
                 ...
                 <div className='flex center'><p className='MethodologyNumber'><strong>5</strong></p></div>
                 <div className='flex center parent'><div className='flex center parent overflowhide'><img src={fourthStage} alt="Wireframe" className='MethodologyImage'/><img src={beneficiosButton} alt="" className="animatedBeneficiosButton"/><img src={OrangeWheel} alt="" className='OrangeWheel' /><img src={WhatsappLogo} alt="" className='OrangeWhatsapp' /></div></div>
               </div>
